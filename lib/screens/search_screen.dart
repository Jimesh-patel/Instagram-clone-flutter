      ...
      body: isShowUsers ? FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return MasonryGridView.count(
            ...
            itemCount: (snapshot.data! as dynamic).docs.length, // Total number of items
            itemBuilder: (context, index) {
              // Determine if this item should be large
              final isLarge = index % 7 == 0;

              return LayoutBuilder(
                builder: (context, constraints) {
                  // Calculate item width based on the number of columns
                  final itemWidth = isLarge ? (constraints.maxWidth / 3) * 2 : constraints.maxWidth / 3;
